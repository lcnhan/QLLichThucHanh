...
<body>
                ...
                <div class="panel-header bg-primary-gradient">
                    <div class="page-inner py-5">
                        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                            <div>
                                <h2 class="text-white pb-2 fw-bold">Danh sách ngành học</h2>
                                <h5 class="text-white op-7 mb-2">Quản lý ngành học thuộc khoa CNTT&TT</h5>
                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" class="btn_control text-primary" data-toggle="modal" data-target="#EditClass" onclick="editData('{{$ng->ma_nganh}}'); changePName('{{$ng->ma_nganh}}', '{{$ng->ten_nganh}}')">
                                                            <i class="fas fa-pen"></i>
                                                        </button>
                                                        <button type="button" class="btn_control text-danger" onclick="deleteNganh('{{$ng->ma_nganh}}')">
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content ">
                        <div class="modal-header">
                            <h3 class="modal-title text-secondary">Thêm ngành mới</h3>
                        ...
                        <div class="modal-body">
                            <form action="{{ route('addMajor') }}" method="POST">
                                ...
                                <div class="form-group form-floating-label col-12 col-sm-12 col-md-12 col-lg-12">
                                    <input id="manganh" name="manganh" type="text" class="form-control input-border-bottom" required>
                                    <label for="manganh" class="placeholder">Mã ngành</label>
                                </div>
                                <div class="form-group form-floating-label col-12 col-sm-12 col-md-12 col-lg-12">
                                    <input id="tennganh" name="tennganh" type="text" class="form-control input-border-bottom" required>
                                    <label for="tennganh" class="placeholder">Tên ngành</label>
                                </div>
                    ...
                    <div class="modal-content ">
                        ...
                        <div class="modal-body">
                            <form action="" id="editForm" method="get">
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
                                <div class="form-group form-floating-label col-12 col-sm-12 col-md-12 col-lg-12">
                                    <input id="manganh" name="new_manganh" type="text" class="form-control input-border-bottom" required>
                                    <label for="manganh" class="placeholder">Mã ngành</label>
                                </div>
                                <div class="form-group form-floating-label col-12 col-sm-12 col-md-12 col-lg-12">
                                    <input id="tennganh" name="new_tennganh" type="text" class="form-control input-border-bottom" required>
                                    <label for="tennganh" class="placeholder">Tên ngành</label>
                                </div>
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 text-center mt-3">
    ...
    function editData(id) {
        var url = '{{ route("editMajor", ":id") }}';
        url = url.replace(':id', id);
        $("#editForm").attr('action', url);
    }

    function changePName(ma, ten) {
        $('input[name=new_manganh]').val('' + ma);
        $('input[name=new_tennganh]').val('' + ten);
        console.log(ma + ' - ' + ten);
    }
